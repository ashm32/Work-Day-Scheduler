...
;(function (global, factory) {
    ...
    function set (config) {
        ...
        this._config = config;
        // Lenient ordinal parsing accepts just a number in addition to number + (possibly) stuff coming from _dayOfMonthOrdinalParse.
        // Need To: Remove "ordinalParse" fallback in next major release.
