...
//set all elements with style type
  let timeEl = $('<p>');
  let dayEl = $('<p>');
  let box1 = $('#div1');
  let box2 = $('#div2');
...
// set time format
  ...
  function checkTime() {
// if the current time is before schedule time then set that to future (green)
// if the current time is the same as schedule time then set that to present (red)
// if the current time is after schedule time then set that to past (blue)
//check for each box
